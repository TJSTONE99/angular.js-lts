...
describe('HTML', () => {
  ...
  describe('htmlParser', () => {
    ...
    it('should not parse comments', () => {
      ngInternals.htmlParser('<!--FOOBAR-->', handler);
      expect(comment).not.toBeDefined();
    });

    it('should parse basic format', () => {
      ngInternals.htmlParser('<tag attr="value">text</tag>', handler);
  ...
  it('should not allow JavaScript execution when creating inert document', angular.mock.inject($sanitize => {
  ...
  it('should not allow JavaScript hidden in badly formed HTML to get through sanitization (Firefox bug)', angular.mock.inject($sanitize => {
  ...
  describe('Custom white-list support', () => {
    ...
    beforeEach(angular.mock.module(_$sanitizeProvider_ => {
    ...
    it('should not allow add custom element after service has been instantiated', angular.mock.inject($sanitize => {
  ...
  describe('SVG support', () => {
    ...
    beforeEach(angular.mock.module($sanitizeProvider => {
  ...
  describe('htmlSanitizerWriter', () => {
    ...
    beforeEach(() => {
      html = '';
      uriValidator = jest.fn();
      writer = ngInternals.htmlSanitizeWriter({ push: function (text) { html += text; } }, uriValidator);
    });
    ...
    describe('uri validation', () => {
      ...
      it('should drop non valid uri attributes', () => {
        uriValidator.mockReturnValue(false);
        writer.start('a', { href: 'someUrl' }, false);
        expect(html).toEqual('<a>');

        html = '';
        uriValidator.mockReturnValue(true);
        writer.start('a', { href: 'someUrl' }, false);
...
describe('decodeEntities', () => {
  ...
  it('should unescape text', () => {
    ngInternals.htmlParser('a&lt;div&gt;&amp;&lt;/div&gt;c', handler);
    expect(text).toEqual('a<div>&</div>c');
  });

  it('should preserve whitespace', () => {
    ngInternals.htmlParser('  a&amp;b ', handler);
