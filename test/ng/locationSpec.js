...
describe('$location', () => {
  ...
  describe('File Protocol', () => {
    ...
    it('should not include the drive name in path() on WIN', () => {
      ...
      const locationUrl = new ngInternals.LocationHashbangUrl('file:///base', 'file:///', '#!');
  ...
  describe('NewUrl', () => {
    function createLocationHtml5Url() {
      const locationUrl = new ngInternals.LocationHtml5Url('http://www.domain.com:9877/', 'http://www.domain.com:9877/');
    ...
    it('should parse new url', () => {
      let locationUrl = new ngInternals.LocationHtml5Url('http://host.com/', 'http://host.com/');
    ...
    it('should prefix path with forward-slash', () => {
      const locationUrl = new ngInternals.LocationHtml5Url('http://server/', 'http://server/');
      locationUrl.path('b');
    ...
    it('should prepend path with basePath', () => {
      const locationUrl = new ngInternals.LocationHtml5Url('http://server/base/', 'http://server/base/');
    ...
    it('should throw error when invalid server url given', () => {
      const locationUrl = new ngInternals.LocationHtml5Url('http://server.org/base/abc', 'http://server.org/base/');
    ...
    describe('encoding', () => {
      ...
      it('should decode special characters', () => {
        const locationUrl = new ngInternals.LocationHtml5Url('http://host.com/', 'http://host.com/');
      ...
      it('should not decode encoded forward slashes in the path', () => {
        const locationUrl = new ngInternals.LocationHtml5Url('http://host.com/base/', 'http://host.com/base/');
  ...
  describe('HashbangUrl', () => {
    ...
    function createHashbangUrl() {
      const locationUrl = new ngInternals.LocationHashbangUrl('http://www.server.org:1234/base', 'http://www.server.org:1234/', '#!');
    ...
    it('should preserve query params in base', () => {
      const locationUrl = new ngInternals.LocationHashbangUrl('http://www.server.org:1234/base?base=param', 'http://www.server.org:1234/', '#');
    ...
    it('should prefix path with forward-slash', () => {
      const locationUrl = new ngInternals.LocationHashbangUrl('http://host.com/base', 'http://host.com/', '#');
    ...
    it('should set path to forward-slash when empty', () => {
      const locationUrl = new ngInternals.LocationHashbangUrl('http://server/base', 'http://server/', '#!');
    ...
    describe('encoding', () => {
      ...
      it('should decode special characters', () => {
        const locationUrl = new ngInternals.LocationHashbangUrl('http://host.com/a', 'http://host.com/', '#');
        locationUrl.$$parse('http://host.com/a#/%20%3C%3E%23?i%20j=%3C%3E%23#x%20%3C%3E%23');
        expect(locationUrl.path()).toBe('/ <>#');
        expect(locationUrl.search()).toEqual({ 'i j': '<>#' });
        expect(locationUrl.hash()).toBe('x <>#');
      ...
      it('url() should decode non-component special characters in hashbang mode', () => {
        const locationUrl = new ngInternals.LocationHashbangUrl('http://host.com', 'http://host.com');
        locationUrl.$$parse('http://host.com');
  ...
  describe('location watch', () => {
    ...
    it('should not update browser if only the empty hash fragment is cleared', () => {
      ...
      angular.mock.inject(($browser, $rootScope) => {
    ...
    it('should not replace browser url if only the empty hash fragment is cleared', () => {
      ...
      angular.mock.inject(($browser, $location, $window) => {
    ...
    it('should not get caught in infinite digest when replacing path in locationChangeSuccess handler', () => {
      ...
      angular.mock.inject(
        ($browser, $location, $rootScope, $window) => {
    ...
    it('should not infinitely digest when using a semicolon in initial path', () => {
      ...
      angular.mock.inject(($location, $browser, $rootScope) => {
        expect(() => {
          $rootScope.$digest();
        }).not.toThrow();
      });
    ...
    it('should not infinitely digest when updating params containing a quote (via window.location + popstate)', () => {
      initService({ html5Mode: true, supportHistory: true });
      mockUpBrowser({ initialUrl: 'http://localhost:9876/', baseHref: '/' });
      angular.mock.inject(($window, $location, $browser, $rootScope) => {
        $rootScope.$digest();
    ...
    describe('location watch for hashbang browsers', () => {
      ...
      it('should not infinite $digest when going to base URL without trailing slash when $locationChangeSuccess watcher changes path to /Home', () => {
        ...
        angular.mock.inject(($rootScope, $location, $browser) => {
          const $browserUrl = spyOnlyCallsWithArgs($browser, 'url');
      ...
      it('should not infinite $digest when going to base URL without trailing slash when $locationChangeSuccess watcher changes path to /', () => {
        ...
        angular.mock.inject(($rootScope, $location, $browser, $window) => {
          const $browserUrl = spyOnlyCallsWithArgs($browser, 'url');
    ...
    describe('location watch for HTML5 browsers', () => {
      ...
      it('should not infinite $digest when going to base URL without trailing slash when $locationChangeSuccess watcher changes path to /Home', () => {
        initService({ html5Mode: true, supportHistory: true });
        mockUpBrowser({ initialUrl: 'http://server/app/', baseHref: '/app/' });
        angular.mock.inject(($rootScope, $injector, $browser) => {
          const $browserUrl = spyOnlyCallsWithArgs($browser, 'url');
  ...
  describe('wiring', () => {
    ...
    it('should update $location when browser url changes', () => {
      ...
      angular.mock.inject(($window, $browser, $location, $rootScope) => {
    ...
    it('should not $apply when browser url changed inside $apply', () => {
      initService({ html5Mode: false, hashPrefix: '!', supportHistory: true });
      mockUpBrowser({ initialUrl: 'http://new.com/a/b#!', baseHref: '/a/b' });
      angular.mock.inject(($rootScope, $browser, $location, $window) => {
        const OLD_URL = $browser.url(), NEW_URL = 'http://new.com/a/b#!/new';
    ...
    it('should update browser when $location changes', () => {
      initService({ html5Mode: false, hashPrefix: '!', supportHistory: true });
      mockUpBrowser({ initialUrl: 'http://new.com/a/b#!', baseHref: '/a/b' });
      angular.mock.inject(($rootScope, $browser, $location) => {
        const $browserUrl = spyOnlyCallsWithArgs($browser, 'url');
    ...
    it('should replace browser url when url was replaced at least once', () => {
      ...
      angular.mock.inject(($rootScope, $browser, $location) => {
        ...
        expect($browserUrl).toHaveBeenCalledTimes(1);
        expect($browserUrl.mock.calls[$browserUrl.mock.calls.length - 1]).toEqual(['http://new.com/a/b#!/n/url', true, null]);
  ...
  describe('wiring in html5 mode', () => {
    ...
    it('should update $location when browser state changes', () => {
      initService({ html5Mode: true, supportHistory: true });
      mockUpBrowser({ initialUrl: 'http://new.com/a/b/', baseHref: '/a/b/' });
      angular.mock.inject(($location, $rootScope, $window) => {
    ...
    it('should not infinite $digest on pushState() with quote in param', () => {
      initService({ html5Mode: true, supportHistory: true });
      mockUpBrowser({ initialUrl: 'http://server/app/', baseHref: '/app/' });
      angular.mock.inject(($rootScope, $injector, $window) => {
        const $location = $injector.get('$location');
    ...
    it('should replace browser url & state when replace() was called at least once', () => {
      ...
      angular.mock.inject(($rootScope, $location, $browser) => {
        ...
        expect($browserUrl).toHaveBeenCalledTimes(1);
        expect($browserUrl.mock.calls[$browserUrl.mock.calls.length - 1]).toEqual(['http://new.com/a/b/n/url', true, { a: 2 }]);
        expect($location.$$replace).toBe(false);
        expect($location.$$state).toEqual({ a: 2 });
      });
    });
    ...
    it('should use only the most recent url & state definition', () => {
      ...
      angular.mock.inject(($rootScope, $location, $browser) => {
        ...
        expect($browserUrl).toHaveBeenCalledTimes(1);
        expect($browserUrl.mock.calls[$browserUrl.mock.calls.length - 1]).toEqual(['http://new.com/a/b/o/url', true, { b: 3 }]);
        expect($location.$$replace).toBe(false);
        expect($location.$$state).toEqual({ b: 3 });
      });
    });
    ...
    it('should allow to set state without touching the URL', () => {
      ...
      angular.mock.inject(($rootScope, $location, $browser) => {
        ...
        expect($browserUrl).toHaveBeenCalledTimes(1);
        expect($browserUrl.mock.calls[$browserUrl.mock.calls.length - 1]).toEqual(['http://new.com/a/b/', true, { b: 3 }]);
        expect($location.$$replace).toBe(false);
        expect($location.$$state).toEqual({ b: 3 });
      });
    });
    ...
    it('should reset the state on .url() after digest', () => {
      ...
      angular.mock.inject(($rootScope, $location, $browser) => {
        ...
        expect($browserUrl).toHaveBeenCalledTimes(1);
        expect($browserUrl.mock.calls[$browserUrl.mock.calls.length - 1]).toEqual(['http://new.com/a/b/bar', false, null]);
      });
    });
    ...
    it('should force a page reload if navigating outside of the application base href', () => {
      ...
      angular.mock.inject(($window, $browser, $location) => {
        $window.location.href = 'http://new.com/a/outside.html';
        jest.spyOn($window.location, '$$setHref');
  ...
  describe('PATH_MATCH', () => {
    ...
    it('should parse just path', () => {
      const match = ngInternals.PATH_MATCH.exec('/path');
      expect(match[1]).toBe('/path');
    });


    it('should parse path with search', () => {
      const match = ngInternals.PATH_MATCH.exec('/ppp/a?a=b&c');
    ...
    it('should parse path with hash', () => {
      const match = ngInternals.PATH_MATCH.exec('/ppp/a#abc?');
      expect(match[1]).toBe('/ppp/a');
    ...
    it('should parse path with both search and hash', () => {
      const match = ngInternals.PATH_MATCH.exec('/ppp/a?a=b&c#abc/d?');
      expect(match[3]).toBe('a=b&c');
    });
  });
  ...
  describe('link rewriting', () => {
    ...
    let root, link, originalBrowser, lastEventPreventDefault;

    function configureTestLink(options) {
      let linkHref = options.linkHref;
      const relLink = options.relLink;
    ...
    function setupRewriteChecks() {
      return ($browser, $location, $rootElement) => {
    ...
    it('should rewrite when clicked span inside link', () => {
      ...
      angular.mock.inject(
        ...
        setupRewriteChecks(),
        $browser => {
          const span = angular.element(link).find('span');
    ...
    it('should not mess up hash urls when clicking on links in hashbang mode', () => {
      ...
      angular.mock.inject(($rootScope, $compile, $browser, $rootElement, $document, $location) => {
        // we need to do this otherwise we can't simulate events
        $document.find('body').append($rootElement);

        const element = $compile('<a href="#!/view1">v1</a><a href="#!/view2">v2</a>')($rootScope);
    ...
    it('should not mess up hash urls when clicking on links in hashbang mode with a prefix',
      () => {
        let base;
        angular.mock.module($locationProvider => {
          return $browser => {
            window.location.hash = '!!someHash';
    ...
    it('should not throw if element was removed', angular.mock.inject(($document, $rootElement, $location) => {
      // we need to do this otherwise we can't simulate events
      $document.find('body').append($rootElement);
    ...
    it('should not throw when clicking an SVGAElement link', () => {
      ...
      angular.mock.inject(($rootScope, $compile, $browser, $rootElement, $document, $location) => {
        // we need to do this otherwise we can't simulate events
        $document.find('body').append($rootElement);
        const template = '<svg><g><a xlink:href="#!/view1"><circle r="50"></circle></a></g></svg>';
  ...
  describe('location cancellation', () => {
    it('should fire $before/afterLocationChange event', angular.mock.inject(($location, $browser, $rootScope, $log) => {
    ...
    it('should allow $locationChangeStart event cancellation', angular.mock.inject(($location, $browser, $rootScope, $log) => {
      expect($browser.url()).toEqual('http://server/');
      expect($location.url()).toEqual('');
    ...
    it('should allow redirect during $locationChangeStart',
      angular.mock.inject(($location, $browser, $rootScope, $log) => {
        $rootScope.$on('$locationChangeStart', (event, newUrl, oldUrl) => {
          $log.info('before', newUrl, oldUrl, $browser.url());
    ...
    it('should fire $locationChangeSuccess event when change from browser location bar',
      angular.mock.inject(($log, $location, $browser, $rootScope) => {
    ...
    it('should listen on click events on href and prevent browser default in hashbang mode', () => {
      angular.mock.module(() => {
        return ($rootElement, $compile, $rootScope) => {
      ...
      angular.mock.inject(($location, $rootScope, $browser, $rootElement) => {
        let log = '';
    ...
    it('should listen on click events on href and prevent browser default in html5 mode', () => {
      angular.mock.module(($locationProvider, $provide) => {
    ...
    it('should always return the new url value via path() when $locationChangeStart event occurs regardless of cause',
      angular.mock.inject(($location, $rootScope, $browser, log) => {
  ...
  describe('LocationHtml5Url', () => {
    let locationUrl, locationUmlautUrl, locationIndexUrl;
    ...
    it('should complain if no base tag present', () => {
      ...
      angular.mock.inject(($browser, $injector) => {
  ...
  describe('LocationHashbangInHtml5Url', () => {
    ...
    let locationUrl, locationIndexUrl;
  ...
  function initService(options) {
    return angular.mock.module(($provide, $locationProvider) => {
  ...
  function mockUpBrowser(options) {
    angular.mock.module(($windowProvider, $browserProvider) => {
      let browser;
      ...
      $browserProvider.$get = ($document, $window, $log, $sniffer, $$taskTrackerFactory) => {
