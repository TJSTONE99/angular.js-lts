...
describe('ngInclude', () => {
  ...
  describe('basic', () => {
    ...
    it('should trust and use literal urls', angular.mock.inject(($rootScope, $httpBackend, $compile) => {
    ...
    it('should trust and use trusted urls', angular.mock.inject(($rootScope, $httpBackend, $compile, $sce) => {
    ...
    it('should fire $includeContentRequested event on scope after making the xhr call', angular.mock.inject(
      ($rootScope, $compile, $httpBackend) => {
        const contentRequestedSpy = jest.fn((event) => {
    ...
    it('should fire $includeContentLoaded event on child scope after linking the content', angular.mock.inject(
      ($rootScope, $compile, $templateCache) => {
        const contentLoadedSpy = jest.fn((event) => {
    ...
    it('should fire $includeContentError event when content request fails', angular.mock.inject(
      ($rootScope, $compile, $httpBackend, $templateCache) => {
        const contentLoadedSpy = jest.fn(), contentErrorSpy = jest.fn();
    ...
    it('should clear content when error during xhr request',
      angular.mock.inject(($httpBackend, $compile, $rootScope) => {
    ...
    it('should compile only the content', angular.mock.inject(($compile, $rootScope, $templateCache) => {
      // regression
    ...
    it('should not break attribute bindings on the same element', angular.mock.inject(($compile, $rootScope, $httpBackend) => {
      // regression #3793
    ...
    it('should exec scripts when jQuery is included', angular.mock.inject(($compile, $rootScope, $httpBackend) => {
    ...
    it('should not trigger a digest when the include is changed', () => {
      ...
      angular.mock.inject(($$rAF, $templateCache, $rootScope, $compile, $timeout) => {
    ...
    describe('autoscroll', () => {
      ...
      it('should call $anchorScroll if autoscroll evaluates to true',
        angular.mock.inject(($rootScope, $compile, $animate, $timeout) => {
  ...
  describe('and animations', () => {
    ...
    it('should fire off the enter animation',
      angular.mock.inject(($compile, $rootScope, $templateCache, $animate) => {
        let item;
