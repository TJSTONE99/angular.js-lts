...
describe('style', () => {
  ...
  it('should compile style element without binding', angular.mock.inject(($compile, $rootScope) => {
  ...
  it('should compile style element with one simple bind', angular.mock.inject(($compile, $rootScope) => {
  ...
  it('should compile style element with one bind', angular.mock.inject(($compile, $rootScope) => {
  ...
  it('should compile style element with two binds', angular.mock.inject(($compile, $rootScope) => {
  ...
  it('should compile content of element with style attr', angular.mock.inject(($compile, $rootScope) => {
